<template>
    <div class="gist mb-5" v-if="dataFetched">
        ...
        <div :id="'comment' + gist.id" :class="['justify-between', 'text-menu-text', 'font-fira_retina', 'mt-4', 'pt-4', 'border-top', showCommentVisible === gist.id ? 'flex' : 'hidden']">
...
export default {
    ...
    methods: {
        ...
        showComment(id) {
            this.showCommentVisible = this.showCommentVisible === id ? null : id;
        }
    },
    components: {
